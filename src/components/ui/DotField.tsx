...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent) {
      // Viewport-relative mapping (not pageX/pageY with cached offsets):
      // stays correct when the canvas is position:fixed and the page scrolls.
    ...
    // Re-measure when the container itself resizes (not only the window) —
    // e.g. layout shifts, mobile URL bar, or a parent that mounts at 0 width.
